/**
 * RedX API (ported verbatim from backend/src/couriers/redx.ts).
 * Auth via API-ACCESS-TOKEN header. Parcels need a delivery_area_id (the admin
 * form collects an area id; use RedX's /areas lookup to populate it in prod).
 */
import type {
  CourierConfig,
  CourierProvider,
