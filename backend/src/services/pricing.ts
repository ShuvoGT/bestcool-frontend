...
/**
 * Server-side pricing. THE single source of truth for what a product costs
 * right now — flash-sale aware. Client-sent prices are never trusted;
 * cart, checkout and order creation all resolve prices through this module.
 */
