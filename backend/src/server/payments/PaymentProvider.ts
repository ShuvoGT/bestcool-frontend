/**
 * Payment abstraction (ported from backend/src/payments/PaymentProvider.ts).
 * Every online gateway implements this interface; routes and the order flow
...
export interface PaymentProvider {
   ...
   * (anti cross-order-replay) before reporting PAID.
   */
