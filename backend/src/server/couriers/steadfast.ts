/**
 * Steadfast Courier API (ported verbatim from backend/src/couriers/steadfast.ts).
 * Single base URL (no separate sandbox host); use a test API key for testing.
 * Auth via Api-Key + Secret-Key headers.
 */
import type {
  CourierConfig,
  CourierProvider,
