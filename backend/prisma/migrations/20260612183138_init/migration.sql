...
-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'PAID', 'FAILED', 'COD_PENDING', 'REFUNDED');

-- CreateEnum
CREATE TYPE "DeliveryStatus" AS ENUM ('PENDING', 'CONFIRMED', 'SHIPPED', 'DELIVERED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "TransactionStatus" AS ENUM ('INITIATED', 'SUCCESS', 'FAILED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "CourierName" AS ENUM ('STEADFAST', 'PATHAO', 'REDX');

-- CreateEnum
CREATE TYPE "BlockType" AS ENUM ('HERO_SLIDER', 'BANNER', 'RICH_TEXT', 'IMAGE_TEXT', 'IMAGE_GALLERY', 'FEATURED_PRODUCTS', 'FEATURED_CATEGORIES', 'FLASH_SALE', 'TESTIMONIALS', 'FAQ', 'CONTACT_INFO', 'MAP_EMBED');
